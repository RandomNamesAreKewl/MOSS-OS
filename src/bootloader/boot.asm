...
ebr_volume_label:			db 'MOSS System'		; 11 bytes, padded with spaces (or not since it is the perfect length)
...
.retry:
	...
	stc									; set carry flag, some BIOS'es don't properly set the carry flag
